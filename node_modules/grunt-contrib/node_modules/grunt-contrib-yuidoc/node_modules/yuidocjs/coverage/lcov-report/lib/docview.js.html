...
<html>
<head>
    <title>Code coverage report for lib/docview.js</title>
...
<div class='header high'>
    <h1>Code coverage report for <span class='entity'>lib/docview.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; docview.js</div>
</div>
<div class='body'>
...
&nbsp;
            if (title) {
                <span class="missing-if-branch" title="if path not taken"" >I</span>if (this.projectName) {
<span class="cstat-no" title="statement not covered" >                    title += ' - ' + this.projectName;</span>
                }
            } else {
